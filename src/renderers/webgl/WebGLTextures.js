...
function WebGLTextures( _gl, extensions, state, properties, capabilities, utils, info ) {
	...
	function deallocateRenderTarget( renderTarget ) {
		...
		if ( renderTarget.isWebGLMultiviewRenderTarget ) {
			...
			for ( let i = 0, il = renderTargetProperties.__webglViewFramebuffers.length; i < il; i ++ ) {
	...
	function setupRenderTarget( renderTarget ) {
		...
		const isMultiview = (renderTarget.isWebGLMultiviewRenderTarget === true);
		...
		if ( isCube ) {
			...
			if ( isMultipleRenderTargets ) {
				...
				var ext = extensions.get( 'OCULUS_multiview' );
				...
				ext.framebufferTextureMultisampleMultiviewOVR( _gl.FRAMEBUFFER, _gl.COLOR_ATTACHMENT0, colorTexture, 0, samples, 0, numViews );
				...
				ext.framebufferTextureMultisampleMultiviewOVR( _gl.FRAMEBUFFER, _gl.DEPTH_STENCIL_ATTACHMENT, depthStencilTexture, 0, samples, 0, numViews );
