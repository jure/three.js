...
function WebGLMultiview( renderer, gl, extensions ) {

	const DEFAULT_NUMVIEWS = 2;

	// const extensions = extensions;
	const properties = renderer.properties;

	let renderTarget, currentRenderTarget;
	let mat3, mat4, cameraArray, renderSize;
	...
	function isAvailable() {
		...
		if ( available === undefined ) {
			...
			var extension = extensions.get( 'OCULUS_multiview' );
